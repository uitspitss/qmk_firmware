...
[_LOWER] = LAYOUT( \
  ...
  KC_LALT,KC_WNUNDO,KC_WNTHDL,KC_WNTHDR,KC_PLUS,      KC_UNDS, _______, _______, _______,  KC_DEL, \
 ...
 * |------+------+------+------+------|           |------+------+------+------+------|
 * |  F11 |  F12 |SCRSHT|      |      |           | Left | Down |  Up  |Right |  Hen |
 * |------+------+------+------+------|           |------+------+------+------+------|
 * | Reset|RGBTOG|RGBMOD|RGBHUI|RGBHUD|           |RGBVAI|RGBVAD|RGBSAI|RGBSAD| Muhen|
 * `----------------------------------'           `----------------------------------'
 *                  ,--------------------.    ,------,-------------.
 *                  |LOWER|Cmd/Esc| Sft/ |    | Alt/ |Ctr/Ent|RAISE|
 *                  `-------------| Spc  |    | Tab  |-------------.
